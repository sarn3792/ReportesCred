...
namespace Reportes
{
    public class CNBVInusualesBean
    {
        private String tipoReporte = "2";
        ...
        public CNBVInusualesBean(bool operacionPrincipal)
        {
            ...
            set
            {
                if (operacionPrincipal)
                {
                    if (value.Length > 1)
                    {
                        if (value.Length > 2)
                        {
                            tipoOperacion = value.Substring(0, 2).Trim().ToUpper();
                        }
                        else
                        {
                            tipoOperacion = value.Trim().ToUpper();
                        }

                    }
                    else
                    {
                        tipoOperacion = String.Format("0{0}", value);
                    }
                }
                else
                {
            ...
            set
            {
                ...
                //instrumentoMonetario = value.Length > 2 ? value.Substring(0, 2).Trim().ToUpper() : value.Trim().ToUpper();
                {
                    if (value.Length > 1)
                    {
                        if (value.Length > 2)
                        {
                            instrumentoMonetario = value.Substring(0, 2).Trim().ToUpper();
                        }
                        else
                        {
                            instrumentoMonetario = value.Trim().ToUpper();
                        }

                    }
                    else
                    {
                        instrumentoMonetario = String.Format("0{0}", value);
                    }
                }
                else
